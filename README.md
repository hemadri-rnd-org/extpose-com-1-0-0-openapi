# extpose.com API - Version 1.0.0

This repository contains the OpenAPI/Swagger specification for the extpose.com API.
...
- **Version**: 1.0.0
- **File**: openapi.yaml
- **Original Path**: extpose.com/1.0.0/openapi.yaml
